...
class MyClass1:
    def __my_private_method(self, name):
        print("MyClass1:", name)

class MyClass2:
    def __my_private_method(self, name, age):
        print("MyClass2:", name, age)

m3 = MyClass1()
m4 = MyClass2()

m3._MyClass1__my_private_method("Udhay")  
m4._MyClass2__my_private_method("Udhay", 28) 